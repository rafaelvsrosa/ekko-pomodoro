...
export function AboutPomodoro() {
  useEffect(() => {
    document.title = "Entenda a Técnica Pomodoro - Ekko Pomodoro";
  }, []);
    ...
    <MainTemplate>
      <Container>
        <GenericHtml>
          ...
          <br />
          <h2>
            Mas no <strong>Ekko Pomodoro</strong> tem um diferencial!
          </h2>

          <p>
            Nosso site segue o conceito original, mas com algumas melhorias e
          ...
          <p>
            ...
            ao seu histórico, e o site já sugere o próximo ciclo (foco ou
            descanso).
          </p>
          <p>
          ...
          <br />
          <h2>Por que usar o Ekko Pomodoro?</h2>
          <ul>
